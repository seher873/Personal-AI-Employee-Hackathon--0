        ...
        if "data" in data:
            for page in data["data"]:
                ...
                if "instagram_business_account" in page:
                    ...
                    print(f"    ⚠️  No Instagram Business Account linked to this page")
        else:
            ...
            if "data" in simple_data:
                for page in simple_data["data"]:
                    ...
                    if ig_response.status_code == 200:
                        ...
                        print(f"  ⚠️  Error checking Instagram account for page {page_id}: {ig_response.text}")
...
def update_env_file(ig_id):
    ...
    if updated:
        ...
        print("⚠️  Could not find IG_ID line in .env file to update")
