...
CRON_JOBS = {
    # Watchers - Browser watchers run at reboot (continuous processes)
    "fb_ig_watcher": {
        "schedule": "@reboot",
        "script": "fb_ig_browser_watcher.py --platform both --interval 60",
        "description": "Facebook/Instagram Watcher - Runs continuously at boot"
    },
    "twitter_watcher": {
        "schedule": "@reboot",
        "script": "twitter_browser_watcher.py --interval 60 --headless",
        "description": "Twitter/X Watcher - Runs continuously at boot"
    },
    # Other watchers run every minute (quick scripts)
    "gmail_watcher": {
        "schedule": "* * * * *",
